...
<span style="white-space:pre;"> 
</span><span style="font-size:14px;">var width=document.documentElement.clientWidth;//获取屏幕的宽度  
    ...
    document.documentElement.style.setProperty('--bili', __bili+"rem");//设置css中的变量为--bili，值为__bili</span>  
